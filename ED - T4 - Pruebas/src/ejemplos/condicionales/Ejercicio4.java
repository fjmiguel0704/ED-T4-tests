...
public class Ejercicio4 {
	//PRUEBAS:
			//Introduce UNO y TRES. 
			//Resultado esperado: 4
			//Resultado obtenido: 4
			//Introduce DOS y CUATRO.
			//Resultado esperado: 6
			//Resultado obtenido: 6
			//Introduce CINCO y SIETE. 
			//Resultado esperado: El valor de la segunda tirada es erróneo
			//Resultado obtenido: El valor de la segunda tirada es erróneo
			//Introduce CERO y TRES. 
			//Resultado esperado: El valor de la primera tirada es erróneo
			//Resultado obtenido: El valor de la primera tirada es erróneo
			//Introduce CERO y SIETE. 
			//Resultado esperado: El valor de la primera tirada es erróneo, El valor de la segunda tirada es erróneo
			//Resultado obtenido: El valor de la primera tirada es erróneo, El valor de la segunda tirada es erróneo
